package me.combimagnetron.lagoon.feature.menu.util;

import me.combimagnetron.lagoon.feature.menu.Pos2D;
...
public class FontUtil {
    private static final String OFFSET_FONT_NAME = "windmill:offset";
    private static final String NAMESPACE = "windmill";
    ...
    public static Component multiOffset(Component text, Pos2D addedPos) {
