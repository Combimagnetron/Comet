package me.combimagnetron.lagoon.config.element;
...
public sealed interface Node<T> extends ConfigElement permits Node.SimpleNode {
    ...
    abstract sealed class SimpleNode<T> implements Node<T> permits Node.AnonymousNode, Node.OptionalNode, Node.RequiredNode {
