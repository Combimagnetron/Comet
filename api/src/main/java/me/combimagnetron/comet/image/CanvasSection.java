...
public interface CanvasSection {
    ...
    static class DummyStatic {
        public static final Map<String, CanvasSection> VALUES = new HashMap<>();
    ...
    static Component optimize(BufferedImage section, int font) {
        ...
        for (Map.Entry<Color, ColorGroup> group : colorGroups.entrySet()) {
            ...
            first = false;
            component = component.append(Component.text(canvasSection.symbol()).color(TextColor.color(group.getKey().getRGB()))).font(Key.key(NAMESPACE, "patterns_" + font));
        }
        return component;
    }
