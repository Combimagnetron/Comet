package me.combimagnetron.comet.config.annotation.processor;

import com.typesafe.config.ConfigFactory;
import com.typesafe.config.ConfigObject;
import me.combimagnetron.comet.config.annotation.*;
...
public class Processor {
    ...
    private static Config transform(Class<?> clazz) {
        Config config = Config.config();
        if (!clazz.isAnnotationPresent(me.combimagnetron.comet.config.annotation.Config.class)) {
            return config;
        }
