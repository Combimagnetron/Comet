...
public record SpawnEntityMessage(User user, Entity entity) implements me.combimagnetron.comet.communication.Message {
    ...
    public static SpawnEntityMessage of(User user, Entity entity) {
        return new SpawnEntityMessage(user, entity);
    }

    public static SpawnEntityMessage of(byte[] bytes) {
