...
public record LoadPlanetMessage(User user, java.util.UUID planetId) implements me.combimagnetron.comet.communication.Message {
    ...
    public static LoadPlanetMessage of(User user, java.util.UUID planetId) {
        return new LoadPlanetMessage(user, planetId);
    }

    public static LoadPlanetMessage of(byte[] bytes) {
