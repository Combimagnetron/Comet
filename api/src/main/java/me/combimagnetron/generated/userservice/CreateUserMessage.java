...
public record CreateUserMessage(User user) implements me.combimagnetron.comet.communication.Message {
    ...
    public static CreateUserMessage of(User user) {
        return new CreateUserMessage(user);
    }

    public static CreateUserMessage of(byte[] bytes) {
